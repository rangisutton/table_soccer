...
export const poolTableTestLevel: LevelDef = {
  ...
  boundary: [
    { x: 280, y: 20, edgeMode: 'sink' },
    { x: 100, y: 20 },
    { x: 100, y: 780 },
    { x: 280, y: 780 },
    { x: 520, y: 780, edgeMode: 'sink' },
    { x: 700, y: 780 },
    { x: 700, y: 20 },
    { x: 520, y: 20 },
  ],
  polys: [],
  ellipses: [
    { x: 99, y: 398, rx: 20, ry: 20, angle: 0.0000, mode: 'sink' },
    { x: 700, y: 20, rx: 20, ry: 20, angle: 0.0000, mode: 'sink' },
    ...
    { x: 100, y: 20, rx: 20, ry: 20, angle: 0.0000, mode: 'sink' },
  ],
  goals: [
    {
